...
@section('content')
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="mb-6">
            <a href="{{ route('dashboard.index') }}" class="text-sm text-gray-500 hover:text-gray-900 transition-colors flex items-center gap-1">
        ...
        <div class="bg-white rounded-2xl p-6 sm:p-8 border border-green-100 shadow-sm">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-5 mb-6">
                ...
                <div>
                    ...
                    <p class="text-gray-900 font-mono text-xs">{{ $order['snippe_reference'] }}</p>
                </div>
                @endif
            </div>
